...
def find_calibration_value(calibration_document: List[str], replace_text_numbers: bool = False) -> int:
    calibration_value = 0

    if replace_text_numbers:
        calibration_document = _replace_text_numbers(calibration_document=calibration_document)
